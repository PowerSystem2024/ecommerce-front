...
export default function ProductCard({ product, onAddToCart, onViewDetails }) {
  ...
  return (
    <motion.div
      className="group bg-white rounded-2xl shadow-sm border border-[#2A2A2A]/10 overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative cursor-pointer flex flex-col h-full"
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mb-3 flex-grow">
          <h3 className="font-semibold text-[#0F0F10] mb-1 group-hover:text-[#E11D74] transition-colors font-['Quantico',_sans-serif] text-lg line-clamp-2 min-h-[3.5rem]">
            {product.name}
          </h3>
          <p className="text-[#2A2A2A] text-sm font-['Rajdhani',_sans-serif] line-clamp-2 min-h-[2.5rem]">
            {product.description}
          </p>
        </div>

        {/* Información adicional */}
        <div className="flex items-center justify-between mb-4 text-xs text-[#2A2A2A] font-['Rajdhani',_sans-serif] flex-shrink-0">
